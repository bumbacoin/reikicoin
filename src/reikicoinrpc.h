...
#ifndef _reikicoinRPC_H_
#define _reikicoinRPC_H_ 1
...
enum RPCErrorCode
{
    ...
    // P2P client errors
    RPC_CLIENT_NOT_CONNECTED        = -9,  // reikicoin is not connected
...
/**
 * reikicoin RPC command dispatcher.
 */
class CRPCTable
{
private:
